...
export const keyboards = {
    ...
    nowAdmin:             [["پاک کردن سوال","ادیت سوال","تایید سوال"],["حذف ادمین","لیست کاربران","لیست ادمین ها"],["پیام به همه"],["ذخیره کردن اطلاعات"],["ذخیره سازی و ارسال اطلاعات"],["برگرد اول کار"]],
    ...
    startEdit:            [["برگرد اول کار"]],
    chooseEdit:           [["برگرد اول کار"],["نام سوال","سختی سوال","تگ های سوال"],["صورت سوال","هینت سوال","جواب سوال"]],
    EditName:             [["برگرد اول کار"]],
    EditDif:              [["آسون","متوسط","سخت"],["برگرد اول کار"]],
    EditTag:              [["برگرد اول کار"]],
    EditText:             [["برگرد اول کار"]],
    EditHint:             [["برگرد اول کار"]],
    EditSol:              [["برگرد اول کار"]]
}
